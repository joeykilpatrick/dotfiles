...
# Default to only setting file permissions for current user, no group/other
umask 077

# Modified from: https://github.com/mathiasbynens/dotfiles/blob/main/.bash_profile
#
# Load the shell dotfiles, and then some:
# * ~/.bash_path can be used to extend `$PATH`.
# * ~/.bash_extra can be used for other settings you don’t want to commit.
for file in ~/.{bash_path,bash_aliases,bash_extra}; do
